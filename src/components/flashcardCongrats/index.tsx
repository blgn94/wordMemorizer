/**
*   FlashcardCongrats бүрэлдэхүүн хэсэг
*   
*   Энэ бүрэлдэхүүн хэсэг нь дуусгасны дараа хэрэглэгчдэд баяр хүргэх мессеж болон сонголтуудыг харуулдаг
*   Flashcard session. Хэрэглэгч хатуу нөхцөлүүдийг хянаж эсвэл Flashcards-ийг дахин эхлүүлэх боломжтой.
*   
*   Properties:
*   - learning: Хэрэглэгчийн сурч байгаа нэр томъёоны тоог илэрхийлдэг тоо.
*   - total: Flashcard сессийн нийт нэр томъёоны тоо.
*   - changeContent: Хэрэглэгчийн сонголт дээр үндэслэн контентыг шинэчлэх функц.
*/
